...
document.getElementById('climateBtn').addEventListener('click', function() {
    ...
    setTimeout(() => {
        ...
        startInfoTransition();
    }, 5000); // Hiệu ứng quay trong 5 giây
});
...
function resizeVideo() {
    ...
    video.style.width = '250px'; // Đặt chiều rộng mong muốn
    video.style.height = 'auto'; // Giữ nguyên tỷ lệ khung hình
}
...
function displayThankYou() {
    ...
    thankYouSection.appendChild(exitBtn);

    // Xử lý sự kiện cho nút Thoát
    exitBtn.addEventListener('click', function() {
        window.location.href = 'about:blank'; // Chuyển đến trang trống
    });
}
...
sections[0].innerHTML = `
    ...
    <div style="text-align: left;">
        ...
        <video controls autoplay muted loop>
            <source src="videos/temperature_video.mp4" type="video/mp4"width: 25%>
...
sections[1].innerHTML = `
    ...
    <div style="text-align: left;">
        ...
        <video controls autoplay muted loop>
            <source src="videos/storm_video.mp4" type="video/mp4"width: 25%>
            Your browser does not support the video tag.
        </video>
    </div>
`;
...
sections[2].innerHTML = `
    ...
    <div style="text-align: left;">
        ...
        <video controls autoplay muted loop>
            <source src="videos/sea_level_video.mp4" type="video/mp4"width: 25%>
            Your browser does not support the video tag.
        </video>
    </div>
`;
...
sections[3].innerHTML = `
    ...
    <div style="text-align: left;">
        ...
        <video controls autoplay muted loop>
            <source src="videos/drought_video.mp4" type="video/mp4"width: 25%>
            Your browser does not support the video tag.
        </video>
    </div>
`;
